...
const ClientsServed = () => {
  return (
    <section className="py-12 bg-[#F7FBFF] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
            Trusted by leading hospitals and healthcare institutions.
          </p>
        </div>
        ...
        <div className="relative w-full overflow-hidden">
          <div className="flex gap-10 animate-marquee hover:[animation-play-state:paused]">
            ...
            {clients.map((client) => (
              <div
                key={client.id}
                className="flex items-center justify-center min-w-[160px] bg-white rounded-xl p-4 border border-gray-200 shadow-sm"
              >
                <img
                  src={client.logo}
                  alt={client.name}
