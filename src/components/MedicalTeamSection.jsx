    ...
    <section className="w-full py-20 bg-white">
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="md:w-1/2">
          {/* Green line */}
          <div className="w-16 h-[3px] bg-green-500 mb-4"></div>
          ...
          <button className="bg-[#21297f] text-white px-8 py-3 rounded-sm font-semibold border-b-4 border-green-500 hover:bg-[#1b216a] transition duration-300">
            READ MORE
          </button>
        </div>
